  ...
  <div class="flex itemsCtr grow head1">
    <svg class="flex logo stdPaddingLt" width="227" height="36" viewBox="0 0 227 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        fill="#B3E5DA" />
      <path d="M41.6321 12.2254H37.1027V11.3994H47.0781V12.2254H42.5487V23.9685H41.6321V12.2254Z" fill="#B3E5DA" />
      <path
      ...
      <path
        ...
        fill="#B3E5DA" />
      <path d="M85.8614 11.3994H88.7731V23.9685H85.8614V11.3994Z" fill="#B3E5DA" />
      <path
        d="M103.298 11.3994V23.9685H100.908L94.6348 16.3373V23.9685H91.759V11.3994H94.1675L100.422 19.0307V11.3994H103.298Z"
        fill="#B3E5DA" />
      <path d="M108.881 13.7696H104.855V11.3994H115.819V13.7696H111.793V23.9685H108.881V13.7696Z" fill="#B3E5DA" />
      <path
      ...
      <path
        ...
        fill="#B3E5DA" />
      <path d="M184.988 13.7696H180.962V11.3994H191.926V13.7696H187.9V23.9685H184.988V13.7696Z" fill="#B3E5DA" />
      <path d="M193.493 11.3994H196.404V23.9685H193.493V11.3994Z" fill="#B3E5DA" />
      <path
    ...
    <div class="links flex grow contentEnd btnGroup stdPaddingRt">
      ${links
      .map(
      (link, ind) =>
      `<a id="${link.id}" href="${
                      ...
                      (endPt ? endPt === link.href : ind === 0)
                        ...
                        : " text400 textGrey txtDecoNone" }">${link.label}</a>`
      )
      .join("")}
    </div>
  </div>
  <div class="flex text700 call stdPadding">
    <p class="flex textWhite" id="headCall">CALL NOW FOR A CONSULT</p>
    <p class="flex textGreen" id="headNum">123.456.7890</p>
  </div>

  <svg class="hide headerHam stdPaddingRt" width="20" height="12" viewBox="0 0 20 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0H19C19.5523 0 20 0.447715 20 1C20 1.55228 19.5523 2 19 2H0V0Z" fill="white"/>
<path d="M0 5H19C19.5523 5 20 5.44772 20 6C20 6.55228 19.5523 7 19 7H0V5Z" fill="white"/>
<path d="M0 10H19C19.5523 10 20 10.4477 20 11C20 11.5523 19.5523 12 19 12H0V10Z" fill="white"/>
</svg>
